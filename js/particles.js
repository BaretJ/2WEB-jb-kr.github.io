var w = c.width = window.innerWidth,
		...
		opts = {
			...
			repaintColor: '#111', // couleur du fond
			connectionColor: 'rgba(243, 243, 243, 0.2)', // couleur de 50% des points
			rootColor: 'hsla(40,80%,light%,alp)', // couleur point central
			endColor: 'rgba(243, 243, 243, 0.2)', // couleur de 50% des points
			dataColor: 'hsla(40,80%,light%,alp)', // couleur éléctricité
